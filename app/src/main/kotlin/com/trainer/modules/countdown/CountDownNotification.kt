...
class CountDownNotification {
  ...
  constructor(initData: InitData, @ForApplication context: Context, notificationManager: NotificationManager) {
    ...
    notificationBuilder = NotificationCompat.Builder(context)
        ...
        .setContentTitle(initData.title)
        .setAutoCancel(false)
  }
  ...
  @Keep
  @PaperParcel
  data class InitData(@DrawableRes val largeIconDrawable: Int,
                      @DrawableRes val smallIconDrawable: Int,
                      val pendingIntentClassName: String,
                      val pendingIntentRequestCode: Int,
                      val title: String,
                      val notificationId: Int) : Parcelable {

    companion object {
      @JvmField val CREATOR = PaperParcelCountDownNotification_InitData.CREATOR
    }

    override fun writeToParcel(dest: Parcel, flags: Int) = PaperParcelCountDownNotification_InitData.writeToParcel(this, dest, flags)
